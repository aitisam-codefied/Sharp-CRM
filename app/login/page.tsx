...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              ...
              <Button
                type="button"
                variant="link"
                className="text-sm text-gray-600 hover:text-purple-600 p-0 h-auto"
              >
                Forgot Password?
              </Button>
            </div>
            ...
            <Button
              type="submit"
              className="w-full h-12 text-base font-medium bg-purple-600 hover:bg-purple-700 text-white rounded-lg"
              disabled={isLoading}
            >
              {isLoading ? "Signing in..." : "Sign In"}
            </Button>
      ...
      <div
        style={{
          backgroundImage: "URL(sideimg.png)",
          backgroundSize: "cover",
          backgroundPositionX: "center",
        }}
        className="hidden lg:flex m-6 rounded-[20px] lg:w-1/2 bg-gradient-to-br from-purple-600 via-purple-500 to-blue-500 items-center justify-center p-12"
      ></div>
    </div>
  );
}

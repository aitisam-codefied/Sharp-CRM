...
export default function QRScannerPage() {
  ...
  return (
    <DashboardLayout
      breadcrumbs={[{ label: "Admin Dashboard", href: "/dashboard/admin" }, { label: "QR Scanner" }]}
      ...
      <div className="space-y-6">
        <div className="grid gap-6 lg:grid-cols-3">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>QR code formats recognized by the system</CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Common scanning operations</CardDescription>
          </CardHeader>
          <CardContent>

...
export default function ReviewConfirmationForm({
  ...
  return (
    <div className="container mx-auto space-y-10 p-6 bg-gray-50 min-h-screen">
            ...
            {formData.signatureUrl && (
              <div className="mt-6">
                ...
                <img
                  ...
                  alt="Admin Signature"
                  className="border-2 border-[#F87D7D] rounded-lg max-w-[300px]"
                />
              </div>
            )}
          </CardContent>

...
export function NotificationTable({
  ...
  const handleMarkAsRead = async (notificationId: string, title: string) => {
    try {
      await markAsReadMutation.mutateAsync(notificationId);
      toast({
        title: "Notification Marked as Read",
        description: `"${title}" has been marked as read.`,
      });
    } catch (error: any) {
      toast({
        title: "Error",
                  ...
                  <TableCell>
                    <div className="space-y-1 font-semibold">
                      {notification?.metadata?.fullName ||
                        notification?.metadata?.newUserName}
                    </div>
                  </TableCell>
                  <TableCell>
                  ...
                  <TableCell className="text-right">
                    {!notification.isRead ? (
                      <Button
                        ...
                        size="sm"
                        variant="outline"
                        className="transition-all duration-200 hover:bg-green-50 hover:border-green-300 hover:text-green-700"
